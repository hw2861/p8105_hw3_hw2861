...
weather stations between **** and **-**. The **ny_noaa** dataset
contains **7** columns(variables) and **2595176** rows(observations).
...
information about the Precipitation (tenths of mm). The two variables
like snow and snwd give us the information about snowfall and snowdepth
in mm.
